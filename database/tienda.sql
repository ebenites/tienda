...
CREATE TABLE IF NOT EXISTS `tienda`.`provincias` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_provincias_departamentos1_idx` (`departamentos_id` ASC),
...
CREATE TABLE IF NOT EXISTS `tienda`.`distritos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_distritos_provincias1_idx` (`provincias_id` ASC),
...
CREATE TABLE IF NOT EXISTS `tienda`.`clientes` (
  ...
  `distritos_id` CHAR(6) NULL,
  `direccion` VARCHAR(200) NULL,
  `foto` LONGBLOB NULL,
  `foto_tipo` VARCHAR(100) NULL,
  `foto_tamanio` INT(10) NULL,
  `estado` INT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  INDEX `fk_clientes_distritos1_idx` (`distritos_id` ASC),
