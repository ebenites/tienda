...
Modificado por Erick Benites: 6136: $this->debug("serializing array element: $k, ".$this->varDump($v)." of type: $typeDef[arrayType]"); // $v <- Array as String or Object as String
...
class nusoap_server extends nusoap_base {
	...
	* @access   public
	*/
	function service($data=false){
		global $HTTP_SERVER_VARS;

		if(!$data) $data=(isset($GLOBALS['HTTP_RAW_POST_DATA']) ? $GLOBALS['HTTP_RAW_POST_DATA'] : '');
